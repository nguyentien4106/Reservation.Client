...
namespace Reservation.API.Migrations
{
    ...
    [Migration("20240608211621_addmoreinfo1")]
    partial class addmoreinfo1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.Job", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.JobService", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.Rate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.JobService", b =>
                {
                    ...
                    b.HasOne("Reservation.Server.Data.Entities.Job", null)
                        .WithMany("Services")
                        .HasForeignKey("JobId");
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.Rate", b =>
                {
                    b.HasOne("Reservation.Server.Data.Entities.Collaborator", "Collaborator")
                        .WithOne("Rate")
                        .HasForeignKey("Reservation.Server.Data.Entities.Rate", "CollaboratorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Reservation.Server.Data.Entities.Review", b =>
                {
                    b.HasOne("Reservation.Server.Data.Entities.Order", "Order")
                        .WithOne("Review")
                        .HasForeignKey("Reservation.Server.Data.Entities.Review", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
